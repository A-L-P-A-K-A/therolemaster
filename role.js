...
const roles = ["BM", "Imp", "Reb"];
const reactions = ["bm", "imp", "reb"]; // For custom emojis, provide the name of the emoji
...
const embedThumbnailLink = "https://i.imgur.com/6LDYDgQ.png"; // The link for the embed thumbnail
